...
#include "Projectile_Racket_Upgrade.h"
#include "Enemy1AIController.h"
#include "GameFramework/CharacterMovementComponent.h"
#include "Components/CapsuleComponent.h"

AProjectile_Racket_Upgrade::AProjectile_Racket_Upgrade()
{
    // 투사체 속도, 데미지, 사거리
...
void AProjectile_Racket_Upgrade::WeaponHitEffect(AActor* OtherActor)
{
...
void AProjectile_Racket_Upgrade::Tick(float DeltaTime)
{
